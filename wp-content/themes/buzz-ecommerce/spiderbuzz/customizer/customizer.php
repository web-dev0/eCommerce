...
function buzz_ecommerce_customize_preview_js() {
    ...
    wp_enqueue_script( 'buzz_ecommerce_customizer', get_template_directory_uri() . '/spiderbuzz/customizer/js/customizer.js', array( 'customize-preview', 'customize-selective-refresh' ), BUZZ_ECOMMERCE_THEME_VERSION, true );
}
