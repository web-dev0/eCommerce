...
function buzz_ecommerce_homepage_short( $wp_customize ){
    ...
    $wp_customize->add_section( 'buzz_ecommerce_homepage_short', array(
        'title'    => esc_html__( 'Sort Home Page Section', 'buzz-ecommerce' ),
        'priority' => 10,
	...
	$wp_customize->add_control(
		new Buzz_Ecommerce_Drag_Section_Control(
			...
			array(
				...
				'label'       => esc_html__( 'Homepage Sort Sections', 'buzz-ecommerce' ),
				'description' => esc_html__( 'Sort or toggle home page sections.', 'buzz-ecommerce' ),
				'choices'     => array(
