 ...
 */
 function buzz_ecommerce_homepage_slider_section(){
         ...
         * @Customizer Value
         */
        $buzz_ecommerce_main_slider = get_theme_mod( 'buzz_ecommerce_main_slider', false ); 
       ...
       $buzz_ecommerce_slidercategory_title = get_theme_mod('buzz_ecommerce_slider_category_list_header_text', esc_html__('ALL CATEGORYES', 'buzz-ecommerce'));
