	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-3">
	      	...
	      	<div class="<?php if(get_theme_mod('moving_company_lite_header_search')) { ?>col-lg-5 col-md-5 col-6" <?php } else { ?>col-lg-6 col-md-6" <?php } ?> >
	        ...
	        <div class="col-lg-1 col-md-1 col-3">
	      	...
	      	<?php }?>
			<div class="col-lg-3 col-md-3 col-9 call-info">
				<div class="row">
