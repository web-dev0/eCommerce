  ...
  <footer role="contentinfo">
    ...
    <div id="footer-2">
        ...
        <?php if( get_theme_mod( 'moving_company_lite_hide_show_scroll',true) != '') { ?>
          ...
          if($theme_lay == 'Left'){ ?>
            <a href="#" class="scrollup left"><i class="fas fa-arrow-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'moving-company-lite' ); ?></span></a>
          <?php }else if($theme_lay == 'Center'){ ?>
            <a href="#" class="scrollup center"><i class="fas fa-arrow-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'moving-company-lite' ); ?></span></a>
          <?php }else{ ?>
            <a href="#" class="scrollup"><i class="fas fa-arrow-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'moving-company-lite' ); ?></span></a>
          <?php }?>
        <?php }?>
    	</div>
    	<div class="clear"></div>
